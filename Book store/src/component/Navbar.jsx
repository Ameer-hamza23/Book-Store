    ...
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
          setSticky
            ? `sticky shadow-md bg-base-200 duration-300 transition-all ease-in-out dark:bg-slate-600 dark:text-white`
            : ``
        }`}
      >
        <div className="navbar space-x-5">
          ...
          <div className="navbar-end space-x-4">
            <div className="hidden md:block">
              <label className="input input-bordered flex items-center gap-1  dark:bg-slate-900 dark:text-white">
            ...
            <a className="btn bg-slate-700">Button</a>
